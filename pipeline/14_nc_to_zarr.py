...
Reads the two NetCDF files produced by 13_download_monthly_era5.py,
...
for ds_name, ds in [("climate", ds_climate), ("wind_solar", ds_wind_solar), ("pressure", ds_pressure)]:
...
print(f"  Wind/solar variables: {list(ds_wind_solar.data_vars)}")
print(f"  Pressure-level variables: {list(ds_pressure.data_vars)}")

# %%
# Merge into one dataset
print("Merging datasets...")
ds_merged = xr.merge([ds_climate, ds_wind_solar, ds_pressure])
